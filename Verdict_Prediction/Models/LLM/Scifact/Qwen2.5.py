...
joint_lines_file = config.get_dataset_path('SciFact\'.lower(), \'Dev/Evidence Sentences/Google/Final Result/Original_search_results.txt\')
output_file = config.get_dataset_path('SciFact\'.lower(), \'Dev/Result/Google/Qwen2.5/SciFact_Google_classified_claims_Original.txt\')
error_log_file = config.get_dataset_path('SciFact\'.lower(), \'Dev/Result/Google/Qwen2.5/SciFact_Google_error_log_Original.txt\')
