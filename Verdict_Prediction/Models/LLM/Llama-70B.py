...
joint_lines_file = config.get_dataset_path('scifact', 'Dev/Evidence Sentences/Wikipedia/Final Result', 'SciFact_joint_lines_wiki_original.txt')
output_file = config.get_dataset_path('scifact', 'Dev/Result/Wikipedia/Llama-70B', 'SciFact_Wikipedia_classified_claims_original.txt')
error_log_file = config.get_dataset_path('scifact', 'Dev/Result/Wikipedia/Llama-70B', 'SciFact_Wikipedia_error_log_original.txt')
