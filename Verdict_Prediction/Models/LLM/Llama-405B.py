...
joint_lines_file = config.get_dataset_path('scifact', 'Evidence Sentences/Merged', 'merged_evidence.txt')
output_file = config.get_dataset_path('scifact', 'Result/Merged_All_Sources/Llama-405B', 'SciFact_Google_classified_claims_merged_all.txt')
error_log_file = config.get_dataset_path('scifact', 'Result/Merged_All_Sources/Llama-405B', 'SciFact_Google_error_log_merged_all.txt')
