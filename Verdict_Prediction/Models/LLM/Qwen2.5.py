...
joint_lines_file = config.get_dataset_path('scifact', 'Dev/Evidence Sentences/Merged', 'merged_evidence.txt')
output_file = config.get_dataset_path('scifact', 'Dev/Result/Merged_All_Sources/Qwen2.5-72B', 'SciFact_Google_classified_claims_merged_all.txt')
error_log_file = config.get_dataset_path('scifact', 'Dev/Result/Merged_All_Sources/Qwen2.5-72B', 'SciFact_Google_error_log_merged_all.txt')
...
tokenizer = AutoTokenizer.from_pretrained(
    model_path,
    cache_dir=cache_dir,
    # If your model is gated or private, you may need an auth token here:
