...
output_file = config.get_dataset_path('SciFact\'.lower(), \'Dev/Result/Pubmed/Phi-4/SciFact_Pubmed_classified_claims_merged.txt\')
error_log_file = config.get_dataset_path('SciFact\'.lower(), \'Dev/Result/Pubmed/Phi-4/SciFact_Pubmed_error_log_merged.txt\')
