...
# output_files = [
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Llama-70B/SciFact_Wikipedia_classified_claims_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Llama-70B/SciFact_Wikipedia_classified_claims__merged.txt\'),
#         config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Llama-70B/SciFact_Pubmed_classified_claims_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Llama-70B/SciFact_Pubmed_classified_claims__merged.txt\'),
#           config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Llama-70B/SciFact_Google_classified_claims_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Llama-70B/SciFact_Google_classified_claims__merged.txt\')

    
# ]

# error_log_files = [
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Llama-70B/SciFact_Wikipedia_error_log_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Llama-70B/SciFact_Wikipedia_error_log__merged.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Llama-70B/SciFact_Pubmed_error_log_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Llama-70B/SciFact_Pubmed_error_log__merged.txt\'),
#         config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Llama-70B/SciFact_Google_error_log_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Llama-70B/SciFact_Google_error_log__merged.txt\')
# ]
...
# Corresponding output and error log files (one for each input file)
output_files = [
    config.get_dataset_path('PubHealth\'.lower(), \'Result/Merged/Llama-70B/PubHealth_merged_classified_claims.txt\')
]

error_log_files = [
    config.get_dataset_path('PubHealth\'.lower(), \'Result/Merged/Llama-70B/PubHealth_merged_error_log_original.txt\')
]
...
def classify_claim_evidence(claim, evidence):
    ...
    prompt = (
        ...
        "Please answer just A or B or C or D. Please refrain from generating any other words other than A or B or C or D: "
    )
