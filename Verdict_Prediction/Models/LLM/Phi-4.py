...
joint_lines_file = config.get_dataset_path('pubhealth', 'Evidence Sentences/Pubmed/Final Result', 'PubHealth_joint_lines_Original_pubmed.txt')
output_file = config.get_dataset_path('pubhealth', 'Result/Pubmed/Phi-4', 'PubHealth_classified_claims_Original.txt')
error_log_file = config.get_dataset_path('pubhealth', 'Result/Pubmed/Phi-4', 'PubHealth_error_log_Original.txt')
