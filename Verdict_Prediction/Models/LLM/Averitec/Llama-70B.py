...
output_files = [
    config.get_dataset_path('Averitec\'.lower(), \'Result/Merged/Llama-70B/Averitec_merged_classified_claims.txt\')
]

error_log_files = [
    "config.get_dataset_path('averitec', 'Result/Merged/[^/]*/ Checking/Datasets/Averitec/Result/Merged/Llama-70B/Averitec_merged_error_log_original.txt\')
]
