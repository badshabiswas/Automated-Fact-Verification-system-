...
# List of input files
input_files = [
    config.get_dataset_path('averitec', 'Evidence Sentence/Merged', 'merged_evidence.txt')
]

# Corresponding output and error log files (one for each input file)
output_files = [
    config.get_dataset_path('averitec', 'Result/Merged/Llama-405B', 'Averitec_merged_classified_claims.txt')
]

error_log_files = [
    config.get_dataset_path('averitec', 'Result/Merged/Llama-405B', 'Averitec_merged_error_log_original.txt')
]
