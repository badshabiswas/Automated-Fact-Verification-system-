...
# output_files = [
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Qwen2.5/SciFact_Pubmed_classified_claims_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Qwen2.5/SciFact_Pubmed_classified_claims__merged.txt\'),
#         config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Qwen2.5/SciFact_Pubmed_classified_claims_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Qwen2.5/SciFact_Pubmed_classified_claims__merged.txt\'),
#           config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Qwen2.5/SciFact_Pubmed_classified_claims_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Qwen2.5/SciFact_Pubmed_classified_claims__merged.txt\')

    
# ]

# error_log_files = [
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Qwen2.5/SciFact_Pubmed_error_log_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Wikipedia/Qwen2.5/SciFact_Pubmed_error_log__merged.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Qwen2.5/SciFact_Pubmed_error_log_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Pubmed/Qwen2.5/SciFact_Pubmed_error_log__merged.txt\'),
#         config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Qwen2.5/SciFact_Pubmed_error_log_original.txt\'),
#     config.get_dataset_path('PubHealth\'.lower(), \'Result/Google/Qwen2.5/SciFact_Pubmed_error_log__merged.txt\')
# ]
...
# Corresponding output and error log files (one for each input file)
output_files = [
    config.get_dataset_path('Liar\'.lower(), \'Result/Merged/Qwen2.5/Liar_merged_classified_claims.txt\')
]

error_log_files = [
    config.get_dataset_path('Liar\'.lower(), \'Result/Merged/Qwen2.5/Liar_merged_error_log_original.txt\')
]
