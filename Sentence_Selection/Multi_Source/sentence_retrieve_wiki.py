...
articles_file_path = config.get_dataset_path('scifact', 'Dev/Relevant Doc/Wikipedia', 'Original_search_results.json')
...
output_file_path = config.get_dataset_path('scifact', 'Dev/Evidence Sentences/Wikipedia', 'SciFact_joint_lines_wiki_original.txt')
