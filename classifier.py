...
all_claims = list()
all_ids = list()
with open("/scratch/mbiswas2/Fact Checking/Code/pubmed_healthfc_pmids.txt", "r") as f:
...
abstracts = pd.read_csv("/scratch/mbiswas2/Fact Checking/Data Pubmed/pubmed_landscape_abstracts_v_small.csv")
...
output_excel_path = "/home/mbiswas2/ondemand/fact-checking/Implementation comparison/Comparing-Knowledge-Sources-main/Code/Result/predictions_healthfc_DeBERTa-v3-large-mnli-fever-anli-ling-wanli.xlsx"  # Change this to your desired path
...
#Predict scores
print_scores(healthfc_labels_binary, prediction_result)



results_df = pd.DataFrame({
    'Claim': healthfc_yesno_Claims,
    'Actual Label': healthfc_labels_binary,
